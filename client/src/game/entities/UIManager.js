...
export default class UIManager {
    ...
    crearHUD() {
        ...
        this.hudContainer = this.scene.add.container(anchoPantalla - 240, 30).setDepth(100);
        
        const fondoHud = this.scene.add.graphics();
        fondoHud.fillStyle(0x1D0C2E, 0.85).fillRoundedRect(0, 0, 210, 45, 22);
        fondoHud.lineStyle(2, 0x68299e, 1).strokeRoundedRect(0, 0, 210, 45, 22);
        
        this.textoHud = this.scene.add.text(105, 22, '00:00 | 0 PTS', {
    ...
    reposicionarHUD(anchoPantalla) {
        if (this.hudContainer) {
            this.hudContainer.setPosition(anchoPantalla - 240, 30);
        }
    }
